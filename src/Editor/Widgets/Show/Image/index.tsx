 ...
 * @LastEditTime: 2022-10-28 12:50:59
 * @LastEditors: 刘玉田
 * @Description: 图片
 */
...
export const ImageRenderView = (props: Partial<ImageProps>) => {
  const { height, alt, preview, src, uploadSrc, marginAndPadding } = props;
  ...
  return (
    <HiddenElement hidden={false} className={NAME} inline={true} style={style}>

...
(function () {
    ...
    var NodeScriptLoader = /** @class */ (function () {
      ...
      NodeScriptLoader.prototype._initNodeRequire = function (
        ...
        Module.prototype._compile = function (content, filename) {
          ...
          var cachedDataPath = that._getCachedDataPath(
            nodeCachedData,
            filename
          );
    ...
    function (require, exports) {
      ...
      function load(name, req, load, config) {
        ...
        const useDefaultLanguage =
          language === null || language === DEFAULT_TAG;
        let suffix = ".nls";
  ...
  define(
    ...
    function (require, exports, characterClassifier_1) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.getMapForWordSeparators = exports.WordCharacterClassifier =
        void 0;
  ...
  define(
    ...
    function (require, exports) {
      ...
      (function (EditorOption) {
        ...
        EditorOption[(EditorOption["foldingStrategy"] = 40)] =
          "foldingStrategy";
        ...
        class ChainableEvent {
          ...
          forEach(fn) {
            return new ChainableEvent(
              forEach(this.event, fn, this.disposables)
            );
          }
          filter(fn) {
    ...
    function (
      ...
      (function (CompletionItemKinds) {
        ...
        byKind.set(
          ...
          codicons_1.Codicon.account
        );
        byKind.set(
          26 /* CompletionItemKind.Issue */,
          codicons_1.Codicon.issues
        );
        /**
         * @internal
         */
      ...
      (function (SymbolKinds) {
        ...
        byKind.set(
          ...
          codicons_1.Codicon.symbolPackage
        );
